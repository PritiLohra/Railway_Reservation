				...
				<form class="form-signin " method="post" action="login.php">
					...
					<table class="table" style="margin-bottom:4px;">
						...
						<tr>
							...
							<td style="border-top:0px;"> <input type="text" name="user" class="input-block-level"
									placeholder="Username"></td>
						</tr>
						<tr>
							<td style="border-top:0px;"> <label>Password</label></td>
							<td style="border-top:0px;"><input type="password" name="psd" class="input-block-level"
									placeholder="password"></td>
						</tr>
						<tr>
							<td colspan=2 style="border-top:0px; visibility:hidden;" id="wrong"
								class="label label-important">Username and Password Wrong !!!</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" style="border-top:0px; text-align:center;">
								<p> You don't have register? <a href="signup.php?value=0">Signup</a></p>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="border-top:0px; text-align:center;"> <a
									href="admin_login.php?value=0"> Login as an admin </a></td>
						</tr>
