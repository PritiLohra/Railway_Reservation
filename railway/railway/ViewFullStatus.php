...
$tostn = $_GET['tostn'];
$sql = "SELECT Tnumber,doj,Name,Ctype,Status,class FROM $tbl_name WHERE (uname='$name1' and Tnumber='$tno' and doj='$doj' and fromstn='$fromstn' and tostn='$tostn')";
			...
			<div>
				<table class="table">
					...
					<tr>
						...
						<th style="width:100px;border-top:0px;">Ctype</th>
					...
					?>
					<?php
					$sql2 = "Select " . "B1" . " from train_list WHERE Number=$tno";
					//echo $sql2;
