	...
	<div class="wrap">
		...
		<div class="span12 well">
				...
				<form method="get" action="booking.php">
					...
					<table class="table" style="border-style:ridge;">
						...
						<tr>
							...
							<th style="border-top:0px;"> B1</th>
							<th style="border-top:0px;"> B2 </th>
							<th style="border-top:0px;"> B3 </th>
							<th style="border-top:0px;"> B4 </th>
						</tr>
						<tr>
							...
							<td style="border-top:0px;"> <input type="radio" name="selct" value="B1"
									onclick="return false;" <?php if ($_GET['class'] == 'B1') {
										echo 'checked';
									} ?>> </td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="B2"
									onclick="return false;" <?php if ($_GET['class'] == 'B2')
										echo 'checked'; ?>> </td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="B3"
									onclick="return false;" <?php if ($_GET['class'] == 'B3')
										echo 'checked'; ?>> </td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="B4"
									onclick="return false;" <?php if ($_GET['class'] == 'B4')
										echo 'checked'; ?>> </td>
						</tr>
					</table>
			...
			<div class="display" style="margin-top:0px;height:415px;">
				<h2>
					<font color="blue">Commodity Detail</font>
				</h2>

				<table class="table">
					<tr>
						<th style="width:100px;border-top:0px;">SNo.</th>
						<th style="width:200px;border-top:0px;"> Commodity Name</th>
						<th style="width:100px;border-top:0px;"> Commodity Type </th>
					</tr>
					<tr>
						<td> 1</td>
						<td><input type="text" name="name1"></td>
						<td><select name="Ctype1" class="input-small">
								<option value=""></option>
					...
					<tr>
						...
						<td><select name="Ctype2" class="input-small">
								<option value=""></option>
								<option value="Coal">Coal</option>
								<option value="Liquid">Liquid</option>
								<option value="Metals">Metals</option>
					...
					<tr>
						...
						<td><select name="Ctype3" class="input-small">
								<option value=""></option>
								<option value="Coal">Coal</option>
								<option value="Liquid">Liquid</option>
								<option value="Metals">Metals</option>
					...
					<tr>
						...
						<td><select name="Ctype4" class="input-small">
								<option value=""></option>
								<option value="Coal">Coal</option>
								<option value="Liquid">Liquid</option>
								<option value="Metals">Metals</option>
					...
					<tr>
						...
						<td><select name="Ctype5" class="input-small">
								<option value=""></option>
								<option value="Coal">Coal</option>
								<option value="Liquid">Liquid</option>
								<option value="Metals">Metals</option>
					...
					<tr>
						<td style="border-top:0px;"><input class="btn btn-info" type="submit" value="Submit" id="subb">
						</td>
