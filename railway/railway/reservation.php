...
<body>
	<div class="wrap">
		...
		<div class="header">
			...
			<div>
				<div style="float:right; font-size:20px;margin-top:20px;color:white;">
				...
				<form method="post" action="reservation.php">
					<table class="table">
						<tr>
							...
							<td style="border-top:0px;"><input type="text" class="input-block-level" name="from"
									id="fr"></td>
						</tr>
						<tr>
							<th style="border-top:0px;"><label> To <label></th>
							<td style="border-top:0px;"><input type="text" class="input-block-level" name="to" id="to1">
							</td>
						</tr>
						<tr>
							<th style="border-top:0px;"><label> Type Of Train <label></th>
							<td style="border-top:0px;"><input list="q1" class="input-block-level" name="quota" id="q12"
									value="<?php if (isset($_POST['quota']))
										echo $_POST['quota']; ?>">
								<datalist id="q1">
									<option value=""></option>
						...
						<tr>
							...
							<td style="border-top:0px;"><input type="date" class="input-block-level input-medium"
									name="date" max="<?php echo date('Y-m-d', time() + 60 * 60 * 24 * 90); ?>"
						...
						<tr>
							...
							<td style="border-top:0px;"><a href="reservation.php" class="btn btn-info" type="reset"
							...
							while ($row = mysqli_fetch_array($result)) {
								...
								if ($n % 2 == 0) {
									...
									<tr class="text-error">
										...
										<td style="width:200px;">
											<a class="text-error"
												href="reser.php?tno=<?php echo $row['Number'] ?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota; ?>&class=<?php echo "B1"; ?>"><b>B1</b></a>
											<a class="text-error"
												href="reser.php?tno=<?php echo $row['Number'] ?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota; ?>&class=<?php echo "B2"; ?>"><b>B2</b></a>
											<a class="text-error"
												href="reser.php?tno=<?php echo $row['Number'] ?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota; ?>&class=<?php echo "B3"; ?>"><b>B3</b></a>
											<a class="text-error"
												href="reser.php?tno=<?php echo $row['Number'] ?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota; ?>&class=<?php echo "B4"; ?>"><b>B4</b></a>
								...
								<?php
									...
									<tr class="text-info">
										...
										<td style="width:200px;">
											<a class="text-info"
												href="reser.php?tno=<?php echo $row['Number'] ?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota; ?>&class=<?php echo "B1"; ?>"><b>B1</b>
											</a>
											<a class="text-info"
												href="reser.php?tno=<?php echo $row['Number'] ?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota; ?>&class=<?php echo "B2"; ?>"><b>B2</b></a>
											<a class="text-info"
