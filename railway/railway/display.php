...
mysqli_select_db($conn,"$db_name") or die("cannot select db");
	$name1=$_SESSION['name'];
	$sql="SELECT DISTINCT Tnumber,class,doj,fromstn,tostn,Status FROM $tbl_name WHERE uname='$name1' ORDER BY doj ASC";
...
<body>
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<div >
				...
				<tr class="text-error">
					...
					<th style="width:100px;"><a href="ViewFullStatus.php?Tnumber=<?php echo $row['Tnumber'];?>&doj=<?php echo $row['doj'];?>&fromstn=<?php echo $row['fromstn']; ?>&tostn=<?php echo $row['tostn']; ?>">View Full Status </a> </th>
				</tr>
				<?php 
					}
					else
		...
		<div style="width:100%;">
			...
			<p class="text-right text-info">	Desinged By : PRITI LOHRA</p>
			</div>
		</div>
		</footer>
	</div>
